...
- 각 차량은 후보를 정하기 전에 아래 순서를 반드시 지켜 독립적으로 관찰하세요.
  ...
  3. 헤드램프·후면 램프: 전면 헤드램프의 외곽 형태, 내부 그래픽과 주간주행등 배치를 확인하고, 같은 단계에서 후면 램프의 외곽 형태, 내부 그래픽, 점등 패턴과 좌우 연결 구조도 함께 확인하세요.
...
- evidence에는 위 8개 항목을 같은 순서로 정확히 8개 작성하고, 각 문자열을 "로고:", "범퍼:", "헤드램프·후면 램프:", "라디에이터 그릴:", "루프:", "포그 램프:", "에어덕트:", "전체 외관:"으로 시작하세요.
- 차량 각도나 가림 때문에 전면 또는 후면 램프 중 하나만 보이면 보이는 쪽만 분석하고, 보이지 않는 쪽은 추측하지 말고 "관찰 불가"라고 명시하세요.
...
- {"summary":"분석 요약","vehicles":[{"id":"VEH_01","description":"차량 설명","confidence":0,"color":"색상","bodyType":"차체 유형","box":{"left":0,"top":0,"width":0,"height":0},"candidates":[{"name":"예상 차종","confidence":0}],"evidence":["로고: 관찰 내용","범퍼: 관찰 내용","헤드램프·후면 램프: 전면 관찰 내용 / 후면 관찰 내용","라디에이터 그릴: 관찰 내용","루프: 관찰 내용","포그 램프: 관찰 내용","에어덕트: 관찰 내용","전체 외관: 관찰 내용"]}]}
`;
